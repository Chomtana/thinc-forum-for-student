...
module.exports = function gulpPug(options) {
  ...
  return through.obj(function compilePug(file, enc, cb) {
    ...
    global.relativetosrc = path.relative(path.dirname(file.path),global.srcAbsolutePath);
    if (global.relativetosrc == "") global.relativetosrc = ".";
    //console.log(path.dirname(file.path),global.relativetosrc);
